...
myForm.addEventListener('submit', e => {
    ...
    // yet if you iterate through formData with 'of' it will show you the keys as though you've called the entries method of the Object class with it as the argument
